...
export const getAppTheme = (isDarkMode: boolean) =>
  createTheme({
    palette: {
      ...
      background: {
        default: isDarkMode ? '#050505' : '#fafafa',
        paper: isDarkMode ? 'rgba(255, 255, 255, 0.03)' : 'rgba(0, 0, 0, 0.02)',
      },
      text: {
      ...
      MuiCssBaseline: {
        styleOverrides: {
          body: {
            ...
            `
              : `
              radial-gradient(circle at 20% 30%, rgba(156, 39, 176, 0.02) 0%, transparent 40%),
              radial-gradient(circle at 80% 70%, rgba(0, 229, 255, 0.02) 0%, transparent 40%)
            `,
